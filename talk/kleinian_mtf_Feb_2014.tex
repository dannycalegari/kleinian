...
is a complex vector space $W$ of dimension 2. 
\vskip 10pt
...
around these points.
\vskip 10pt
If $w_1$ and $w_2$ are a basis for $W$, the map $$D:z \to w_1(z)/w_2(z)$$ is well-defined
...
\vskip 10pt
\textcolor{blue}{Hyperbolization Theorem}: a closed 3-manifold $M$ admits a hyperbolic structure if and only if
\begin{enumerate}
...
stay in either of the ends, but keeps coming back to any compact region.
}
\frame
{
